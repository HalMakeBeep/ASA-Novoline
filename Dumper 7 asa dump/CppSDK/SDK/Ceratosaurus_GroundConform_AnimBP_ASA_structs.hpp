...
// ScriptStruct Ceratosaurus_GroundConform_AnimBP_ASA.Ceratosaurus_GroundConform_AnimBP_ASA_C.AnimBlueprintGeneratedConstantData
// 0x02AF (0x02B0 - 0x0001)
struct Ceratosaurus_GroundConform_AnimBP_ASA::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_ControlRig;                     // 0x0280(0x0030)()
};
DUMPER7_ASSERTS_Ceratosaurus_GroundConform_AnimBP_ASA__FAnimBlueprintGeneratedConstantData;
