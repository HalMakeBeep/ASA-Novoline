...
struct PrimalInventoryBP_ArtifactCrate_C_BPRequestedInventoryItems final
{
public:
	...
	TArray<class UPrimalItem*>                    LocalNewItems;                                     // 0x0008(0x0010)(Edit, BlueprintVisible)
	double                                        CrateQualityMult;                                  // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class APrimalBuff*>                    CallFunc_GetBuffs_TheBuffs;                        // 0x0038(0x0010)(ReferenceParm)
	...
	class APrimalBuff*                            CallFunc_Array_Get_Item;                           // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ABuff_CrateBoosting_Base_C*             K2Node_DynamicCast_AsBuff_Crate_Boosting_Base;     // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APrimalStructureItemContainer_SupplyCrate* K2Node_DynamicCast_AsPrimal_Structure_Item_Container_Supply_Crate; // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GenerateCrateItems_ReturnValue;           // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GenerateCrateItems_MinQualityMultiplier_ImplicitCast; // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GenerateCrateItems_MaxQualityMultiplier_ImplicitCast; // 0x012C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_PrimalInventoryBP_ArtifactCrate_C_BPRequestedInventoryItems;

// Function PrimalInventoryBP_ArtifactCrate.PrimalInventoryBP_ArtifactCrate_C.BPPreInitDefaultInventory
// 0x0003 (0x0003 - 0x0000)
struct PrimalInventoryBP_ArtifactCrate_C_BPPreInitDefaultInventory final
{
public:
...
DUMPER7_ASSERTS_PrimalInventoryBP_ArtifactCrate_C_BPPreInitDefaultInventory;
