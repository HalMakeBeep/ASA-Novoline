...
// Parameters:
// class UMaterialInstanceDynamic*         MI                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// const struct FLinearColor&              Location                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// double                                  Color_Mult                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Write_Lightning_to_Clouds_RT(class UMaterialInstanceDynamic* MI, const struct FLinearColor& Location, const struct FLinearColor& Color, double Color_Mult)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Write Lightning to Clouds RT");

	Params::Ultra_Dynamic_Weather_C_Write_Lightning_to_Clouds_RT Parms{};

	Parms.MI = MI;
	Parms.Location = std::move(Location);
	Parms.Color = std::move(Color);
	Parms.Color_Mult = Color_Mult;
...
void AUltra_Dynamic_Weather_C::WOV_State(bool* Enabled)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "WOV_State");

	Params::Ultra_Dynamic_Weather_C_WOV_State Parms{};
...
void AUltra_Dynamic_Weather_C::Update_Season(struct FVector* Point)
{
	static class UFunction* Func = nullptr;
	...
	Params::Ultra_Dynamic_Weather_C_Update_Season Parms{};
...
// (Protected, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool*                                   Point_in_Storm                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   Player_in_Storm                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double*                                 Player_Distance_from_Center                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AUltra_Dynamic_Weather_C::Update_Current_Material_Effects(bool* Point_in_Storm, bool* Player_in_Storm, double* Player_Distance_from_Center)
{
	...
	Params::Ultra_Dynamic_Weather_C_Update_Current_Material_Effects Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Point_in_Storm != nullptr)
		*Point_in_Storm = Parms.Point_in_Storm;

	if (Player_in_Storm != nullptr)
		*Player_in_Storm = Parms.Player_in_Storm;

	if (Player_Distance_from_Center != nullptr)
		*Player_Distance_from_Center = Parms.Player_Distance_from_Center;
}
...
void AUltra_Dynamic_Weather_C::Start_Weather_Transition()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Start Weather Transition");
...
void AUltra_Dynamic_Weather_C::SetupDCM()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "SetupDCM");
...
void AUltra_Dynamic_Weather_C::ROS_ChangeWeather(EUDS_WeatherTypesASA New_Weather_Type, double Transition_Length, bool Reset_Particle_Emitters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "ROS_ChangeWeather");

	Params::Ultra_Dynamic_Weather_C_ROS_ChangeWeather Parms{};
...
// Function Ultra_Dynamic_Weather.Ultra_Dynamic_Weather_C.OnRep_CurrWeatherType
// (BlueprintCallable, BlueprintEvent)
...
void AUltra_Dynamic_Weather_C::OnRep_CurrWeatherType()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "OnRep_CurrWeatherType");
...
void AUltra_Dynamic_Weather_C::MC_ChangeWeather(EUDS_WeatherTypesASA New_Weather_Type, double Transition_Length, bool Reset_Particle_Emitters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "MC_ChangeWeather");

	Params::Ultra_Dynamic_Weather_C_MC_ChangeWeather Parms{};
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector*                         Lightning_Point                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Lightning_Point_in_Area(struct FVector* Lightning_Point)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Lightning Point in Area");

	Params::Ultra_Dynamic_Weather_C_Lightning_Point_in_Area Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Lightning_Point != nullptr)
		*Lightning_Point = std::move(Parms.Lightning_Point);
}
...
void AUltra_Dynamic_Weather_C::IsOverridingSkylightTemperature(bool* Return)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "IsOverridingSkylightTemperature");

	Params::Ultra_Dynamic_Weather_C_IsOverridingSkylightTemperature Parms{};
...
// bool*                                   Point_in_Storm                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double*                                 Close_to_Storm                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector*                         Random_Point_for_Hit                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector*                         Random_Point_for_Lightning                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::In_Electrical_Storm(const struct FVector& position, bool* Point_in_Storm, double* Close_to_Storm, struct FVector* Random_Point_for_Hit, struct FVector* Random_Point_for_Lightning)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "In Electrical Storm");

	Params::Ultra_Dynamic_Weather_C_In_Electrical_Storm Parms{};
	...
	if (Close_to_Storm != nullptr)
		*Close_to_Storm = Parms.Close_to_Storm;

	if (Random_Point_for_Hit != nullptr)
		*Random_Point_for_Hit = std::move(Parms.Random_Point_for_Hit);

	if (Random_Point_for_Lightning != nullptr)
		*Random_Point_for_Lightning = std::move(Parms.Random_Point_for_Lightning);
}
...
void AUltra_Dynamic_Weather_C::GetSnowAmount(double* Snow_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "GetSnowAmount");

	Params::Ultra_Dynamic_Weather_C_GetSnowAmount Parms{};
...
void AUltra_Dynamic_Weather_C::GetRainAmount(double* Rain_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "GetRainAmount");

	Params::Ultra_Dynamic_Weather_C_GetRainAmount Parms{};
...
// double*                                 WindDirection_Yaw_                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// double*                                 Relative_Temperature                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AUltra_Dynamic_Weather_C::GetConditions(double* WindStrength, double* WindDirection_Yaw_, double* Temperature_C, double* Temperature_F, double* Relative_Temperature, bool* IsRaining, bool* IsSnowing, bool* IsHeatwave, bool* IsColdfront)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "GetConditions");

	Params::Ultra_Dynamic_Weather_C_GetConditions Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (WindStrength != nullptr)
		*WindStrength = Parms.WindStrength;

	if (WindDirection_Yaw_ != nullptr)
		*WindDirection_Yaw_ = Parms.WindDirection_Yaw_;

	if (Temperature_C != nullptr)
		*Temperature_C = Parms.Temperature_C;

	if (Temperature_F != nullptr)
		*Temperature_F = Parms.Temperature_F;

	if (Relative_Temperature != nullptr)
		*Relative_Temperature = Parms.Relative_Temperature;

	if (IsRaining != nullptr)
		*IsRaining = Parms.IsRaining;

	if (IsSnowing != nullptr)
		*IsSnowing = Parms.IsSnowing;

	if (IsHeatwave != nullptr)
		*IsHeatwave = Parms.IsHeatwave;

	if (IsColdfront != nullptr)
		*IsColdfront = Parms.IsColdfront;
}
...
void AUltra_Dynamic_Weather_C::Get_Current_Temperature(bool Apply_Interior_Temperature, class UUDS_Weather_Settings_C* Custom_Weather_State_Object, double* Celsius, double* Fahrenheit, double* RelativeTemperature)
{
	static class UFunction* Func = nullptr;
	...
	if (RelativeTemperature != nullptr)
		*RelativeTemperature = Parms.RelativeTemperature;
}
...
void AUltra_Dynamic_Weather_C::Find_Lightning_Point_in_Storm(struct FVector* NewParam)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_C", "Find Lightning Point in Storm");

	Params::Ultra_Dynamic_Weather_C_Find_Lightning_Point_in_Storm Parms{};
