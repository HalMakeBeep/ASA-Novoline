...
#include "Bee_AIController_BP_classes.hpp"
#include "Bee_AIController_BP_parameters.hpp"
...
float ABee_AIController_BP_C::BPGetTargetingDesire(class AActor* ForTarget, float ForTargetingDesireValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Bee_AIController_BP_C", "BPGetTargetingDesire");

	Params::Bee_AIController_BP_C_BPGetTargetingDesire Parms{};
