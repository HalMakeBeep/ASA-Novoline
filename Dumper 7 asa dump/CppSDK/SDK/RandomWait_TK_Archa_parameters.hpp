...
struct RandomWait_TK_Archa_C_ExecuteUbergraph_RandomWait_TK_Archa final
{
public:
	...
	class ADino_AIController_BP_C*                K2Node_DynamicCast_AsDino_AIController_BP;         // 0x0010(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_RandomWait_TK_Archa_C_ExecuteUbergraph_RandomWait_TK_Archa;

// Function RandomWait_TK_Archa.RandomWait_TK_Archa_C.ReceiveExecute
// 0x0008 (0x0008 - 0x0000)
struct RandomWait_TK_Archa_C_ReceiveExecute final
{
public:
...
DUMPER7_ASSERTS_RandomWait_TK_Archa_C_ReceiveExecute;
